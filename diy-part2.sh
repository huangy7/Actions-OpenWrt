...
sed -i '/<tr><td width="33%"><%:CPU usage (%)%><\/td><td id="cpuusage">-<\/td><\/tr>/a <tr><td width="33%">系统信息<\/td><td>自用系统，黄云定制，干净卫生，放心食用<\/td><\/tr>' package/lean/autocore/files/x86/index.htm
